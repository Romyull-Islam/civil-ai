...
const TASKS = [
  ...
  { id: "column", prompt: "A short RC column 300x450 mm carries a factored axial load of 1800 kN. M25, Fe500, IS 456. How much longitudinal steel is needed?", tools: ["design_rc_column"], check: (o) => { const a = o.design_rc_column?.result?.AscRequired; return a > 1350 && a < 2000; } }, // interaction design with e,min = 20 mm about the 300 mm side (e,min > 0.05D, so cl. 39.3 does not apply): SP-16 ≈ 1.25%
