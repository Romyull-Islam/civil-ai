...
import { ChevronDown, ChevronRight, Wrench, CheckCircle2, XCircle, AlertTriangle } from "lucide-react";
  ...
  return (
    <div className="card my-2 text-sm">
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border">
        ...
        <button className="ml-auto text-xs text-muted hover:text-fg flex items-center gap-1" onClick={() => setShowArgs((v) => !v)}>{showArgs ? <ChevronDown size={12} /> : <ChevronRight size={12} />} inputs</button>
      </div>
