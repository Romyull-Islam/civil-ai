...
const TITLES: Record<string, string> = {
  ...
  rc_beam_capacity: "RC beam flexural capacity", subdivision_layout: "Subdivision layout", landscape_quantities: "Landscape quantities", irrigation_water_budget: "Irrigation water budget", sprinkler_run_time: "Sprinkler run time", mix_design_aci: "Concrete mix design (ACI 211.1)", mix_design_is10262: "Concrete mix design (IS 10262)", stormwater_runoff: "Stormwater runoff", pipe_channel_flow: "Pipe / channel flow", plan_building: "Building plan",
