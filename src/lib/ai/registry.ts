...
export const PROVIDERS: ProviderInfo[] = [
  ...
  { id: "deepseek", label: "DeepSeek", kind: "openai", keyEnv: "DEEPSEEK_API_KEY", keyUrl: "https://platform.deepseek.com/api_keys", baseUrl: "https://api.deepseek.com/v1", freeTier: "No free tier; Flash $0.30/$1.20 per 1M tokens at peak (half off-peak). Servers in China.", requiresKey: true,
    models: [{ id: "deepseek-flash", label: "DeepSeek V4.1 Flash" }, { id: "deepseek-v4-pro", label: "DeepSeek V4 Pro" }] },
