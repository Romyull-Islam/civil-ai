...
export function rhdFlexibleDesign(inp: RhdInput) {
  ...
  if (src === "appendix") notes.push("Improved subgrade: the guide's Table 6 (250/150/100 mm on CBR 2/3/4 %) conflicts with its Appendix 1 (300/250/200 mm on CBR 3/4/5 %). The guide's own worked example (Appendix 2, subgrade CBR 3 %) specifies 300 mm, the Appendix 1 value (Table 6 would give 150 mm), so Appendix 1 is used; set improvedSubgradeSource to table6 for Table 6.");
