...
const FACTORS: Record<UnitCategory, Record<string, number>> = {
  ...
  // Bangladesh land units: 1 katha = 720 sft, 1 bigha = 20 katha, 1 decimal (shotangsho) = 1/100 acre = 435.6 sft.
  area: { "m2": 1, "mm2": 1e-6, "cm2": 1e-4, "ha": 1e4, "in2": 0.00064516, "ft2": 0.09290304, "yd2": 0.83612736, "acre": 4046.8564224, katha: 720 * 0.09290304, decimal: 4046.8564224 / 100, bigha: 20 * 720 * 0.09290304, shotangsho: 4046.8564224 / 100 },
